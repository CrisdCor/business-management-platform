...
export const MODULOS = {
  ...
  COMPRAS_PRODUCTOS: "compras.productos",
  COMPRAS_UNIDADES_MEDIDA: "compras.unidades_medida",
...
export const MODULO_LABELS: Record<ModuloCodigo, string> = {
  ...
  [MODULOS.COMPRAS_PRODUCTOS]: "Productos",
  [MODULOS.COMPRAS_UNIDADES_MEDIDA]: "Unidades de medida",
